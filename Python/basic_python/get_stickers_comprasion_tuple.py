...
def get_stickers_comparison(collection_1, collection_2):
    collection_1_set = set(collection_1)
    collection_2_set = set(collection_2)
    return sorted(collection_1_set - collection_2_set), sorted(collection_2_set - collection_1_set), sorted(collection_1_set & collection_2_set)
